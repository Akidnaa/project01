                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Tabel Hasil Pemeriksaan</h3>
                        ...
                        <div class="card-body">
                            ...
                            <a href="add.php"><button class="btn btn-success mb-1">Tambah Data</button></a>
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th>ID</th>
                                ...
                                <tbody>
                                    ...
                                    foreach ($query as $row) {
                                        ...
                                        echo "<td>";
                                        echo "<a href='edit.php?id=" . $row['id'] . "'><button class='btn btn-info  '>Edit</button></a>";
